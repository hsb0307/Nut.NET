...
namespace Nut.Web.Framework.Events {
    public class EventsInterceptor : IInterceptor {
        ...
        public static object Adjust(IEnumerable results, Type returnType) {
            ...
            var enumerableOfTypeT = _enumerableOfTypeTDictionary.GetOrAdd(returnType, 
                type => 
                    typeof(Enumerable).GetGenericMethod("OfType", type.GetGenericArguments(), new[] { typeof(IEnumerable) }, typeof(IEnumerable<>)));
