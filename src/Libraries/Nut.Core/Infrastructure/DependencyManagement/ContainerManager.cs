...
namespace Nut.Core.Infrastructure.DependencyManagement {
    public class ContainerManager {
        ...
        public object ResolveUnregistered(Type type, ILifetimeScope scope = null) {
            ...
            foreach (var constructor in constructors) {
                try {
                    ...
                    foreach (var parameter in parameters) {
                        ...
                        if (service == null) throw new NutException("Unkown dependency");
            ...
            throw new NutException("No contructor was found that had all the dependencies satisfied.");
        }
