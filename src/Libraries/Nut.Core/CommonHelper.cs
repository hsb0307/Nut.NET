...
namespace Nut.Core
{
    ...
    {
        public static string BuildStackTraceMessage(Type type)
        {

            StackTrace trace = new StackTrace(true);
            var frameList = trace.GetFrames();
            var realFrameList = frameList.Where(i => i.GetMethod().DeclaringType != type && i.GetFileLineNumber() > 0);
        ...
        public static string EnsureSubscriberEmailOrThrow(string email) {
            ...
            if(!IsValidEmail(output)) {
                throw new NutException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new NutException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new NutException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
